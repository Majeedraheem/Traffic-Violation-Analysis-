...
os.getcwd()
os.chdir('/Users/mac/Desktop/DataMining Project') 
Uncleaned_tvdf=pd.read_csv('Traffic_Violations.csv')
...
#Check null values 
tvdf.isnull().sum().sum()
dftv['ViolationType'].values().count()
dftv['ArrestType'].value_counts()
